...
- Filtrar películas por ciudad y género
...
- **Página de Sedes**: Información sobre todas las ubicaciones disponibles
- **Formulario de Contacto**: Permite a los usuarios comunicarse directamente
- **Diseño Responsivo**: Compatible con dispositivos móviles y de escritorio
- **Navegación Intuitiva**: Menú claro y accesible en todas las páginas
...
- **Swiper**: Librería de carrusel moderno
- **FontAwesome**: Iconografía profesional
- **Google Fonts**: Tipografías personalizadas (Nunito y Poppins)
...
├── places.html          # Página de sedes
├── contact.html         # Página de contacto
├── README.md            # Este archivo
├── assets/
│   ├── icons/           # Iconos del proyecto
│   │   └── footer/      # Iconos específicos del footer
│   └── img/
...
└── css/
    ...
    └── pages/
        ...
        ├── place.css    # Estilos de la página de sedes
